...
QT_MOC_LITERAL(1, 8, 14), // "uid_fix_failed"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 14) // "on_exit_prompt"

    },
    "MapView\0uid_fix_failed\0\0on_exit_prompt"
};
...
void MapView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->uid_fix_failed(); break;
        case 1: _t->on_exit_prompt(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapView::uid_fix_failed)) {
                *result = 0;
                return;
            }
        }
