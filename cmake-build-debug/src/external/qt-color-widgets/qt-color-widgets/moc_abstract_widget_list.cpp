...
#include <memory>
#include "../../../../../src/external/qt-color-widgets/qt-color-widgets/abstract_widget_list.hpp"
...
void AbstractWidgetList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AbstractWidgetList *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AbstractWidgetList::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractWidgetList::removed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AbstractWidgetList::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AbstractWidgetList.data,
    qt_meta_data_AbstractWidgetList,
    qt_static_metacall,
    nullptr,
    nullptr
} };
